...
titleLevels:
  aware: "Cron wrapper for the health run"
  plain: "Put the weekly health check on a schedule"
...
summaryLevels:
  aware: "Added the cron wrapper for the site-health run and documented its Wednesday 07:00 schedule."
  plain: "Scheduled the website health check to run by itself every Wednesday morning."
---
