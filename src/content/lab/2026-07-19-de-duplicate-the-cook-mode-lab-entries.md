...
titleLevels:
  aware: "De-duplicated the Cook Mode entries"
  plain: "Cook Mode was listed twice — fixed"
...
summaryLevels:
  aware: "Removed the duplicate build-log entry for Cook Mode, leaving the single proper write-up."
  plain: "Cook Mode had accidentally been posted here twice. Removed the duplicate."
---
