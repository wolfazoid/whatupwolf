...
titleLevels:
  aware: "Rebuilt the Lab filter UX"
  plain: "Made this page easier to search"
...
summaryLevels:
  aware: "Replaced the growing row of tag buttons with a search box and two dropdowns, backed by a tested filter module."
  plain: "This page had a button for every topic, and there were getting to be far too many. Replaced them with a search box and two simple dropdowns."
---
