...
titleLevels:
  aware: "The direct-vs-review gate"
  plain: "Decided what the machine may publish unsupervised"
...
summaryLevels:
  aware: "Turned what may publish itself and what needs review into an explicit per-type policy the runner applies."
  plain: "Wrote down the rule for what the machine may post on its own and what has to wait for me to read first — so it is a rule, not a habit."
---
